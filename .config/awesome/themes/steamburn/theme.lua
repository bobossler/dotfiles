...
theme.font                                      = "ProductSans-Medium 10.5"
...
-- Weather
local weathericon = wibox.widget.imagebox()
theme.weather = lain.widget.weather({
    APPID = "33dbf77ac9d2c2a105a442ab0a5ce6b2",
    city_id = 4883817,
    units = "imperial",
    settings = function()
...
-- Separators
local first = wibox.widget.textbox(markup.font("ProductSans-Regular 4", " "))
